        ...
        <form class="flex flex-col gap-6" wire:submit="save">
            ...
            <div class="flex gap-4">
                <div class="w-2/3 gap-2 flex flex-col">
                    <label class="text-[14px] text-[#C3C3D1]">{{ __('Email') }}</label>
            ...
            <div>
                <label for="agree"
                    ...
                    <span class="text-[#8C8C9A] text-[14px]">{{ __('I agree to the :terms_of_service and :privacy_policy', ['terms_of_service' => __('Terms of Service'), 'privacy_policy' => __('Privacy Policy')]) }}</span>
                </label>
                @error('agree')
                    <div class="text-red-600 mt-1 text-small">{{ __('You must agree to the :terms_of_service and :privacy_policy', ['terms_of_service' => __('Terms of Service'), 'privacy_policy' => __('Privacy Policy')]) }}</div>
                @enderror
            </div>
            <button class="bg-[#5354FD] text-white font-bold tracking-wide uppercase px-8 py-3 rounded-[4px]
